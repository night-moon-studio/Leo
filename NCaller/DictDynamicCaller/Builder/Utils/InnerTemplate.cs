    ...
    internal class InnerTemplate
    {
        public static string GetNormalInnerString(string type,string className)
        {
            return $@"internal static class {type}<T>{{
                ...
                public readonly static ConcurrentDictionary<string,Func<{className},CallerBase>> LinkMapping;
                ...
                static {type}(){{
                    ...
                    LinkMapping = new ConcurrentDictionary<string,Func<{className},CallerBase>>();
