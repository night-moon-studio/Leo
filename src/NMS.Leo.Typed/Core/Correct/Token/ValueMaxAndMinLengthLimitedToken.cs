...
{
    internal class ValueMaxAndMinLengthLimitedToken : ValueToken
    {
        // ReSharper disable once InconsistentNaming
        public const string NAME = "Array length restriction rules";
        public static int[] _mutuallyExclusiveFlags = {90115, 90119, 90120};

        private readonly int _minLength;
        private readonly int _maxLength;

        public ValueMaxAndMinLengthLimitedToken(LeoMember member, int min, int max) : base(member)
        {
            if (min < 0)
        ...
        public override CorrectValueOps Ops => CorrectValueOps.StrMaxMinLen;
